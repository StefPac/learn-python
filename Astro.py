print("---ASTROPHYISICS---")
what = input("What do you want to learn today leo?")
if what == "black holes":
    ...
    print("Dark energy is what expands our universe. Dark energy is in a constant tug-of-war with dark matter. Dark enegy feeds itself, for evry 100 million kilomiters it expands the universe, it expands the uneverse 21 kilomiters faster")
